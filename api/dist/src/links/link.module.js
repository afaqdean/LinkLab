...
exports.LinkModule = LinkModule = __decorate([
    (0, common_1.Module)({
        controllers: [link_controller_1.LinkController, redirect_controller_1.RedirectController],
        providers: [link_service_1.LinkService, prisma_service_1.PrismaService],
